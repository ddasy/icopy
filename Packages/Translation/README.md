...
- `Sources/ICopyTranslation/TranslationService.swift` — 翻译服务协议与错误类型。
- `Sources/ICopyTranslation/LMStudioTranslationService.swift` — OpenAI 兼容 chat completions 翻译客户端。
